...
class RH8DSensorReader(Node):
    ...
    # Function to retrieve x, y, z vector components for a sensor.
    ...
    # Callback executed whenever a new DynamicJointState message arrives.
    def dynamic_joint_state_callback(self, msg: DynamicJointState):
        ...
        self.get_logger().info('---------------- RH8D Sensor Data Streaming ----------------')
    ...
    # Functions to print the sensor data:
