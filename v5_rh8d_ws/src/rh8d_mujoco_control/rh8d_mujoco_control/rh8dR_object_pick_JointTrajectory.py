...
class RH8DGestureController(Node):
    def __init__(self):
        ...
        # Same idea as your old code: per-actuator command rates
    ...
    def is_value_at_target(self, joint_name: str, target: float, tolerance: float = 0.06) -> bool:
