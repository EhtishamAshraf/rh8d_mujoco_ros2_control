...
class RH8DGestureController(Node):
    def __init__(self):
        ...
        self.gestures = [
            ...
            },
            {
                ...
                "positions": [0.0, -0.7, 0.0, 1.57,
                              self.finger_flexion, self.finger_flexion, self.finger_flexion, self.thumb_flexion],
                "checks": [
                    ('palm_axis:1--forearm:1', -0.7),
                ]
            },
            {
                "name": "Wrist Rotation (+)",
                "positions": [1.57, -0.7, 0.0, 1.57,
                              self.finger_flexion, self.finger_flexion, self.finger_flexion, self.thumb_flexion],
                "checks": [
            ...
            {
                "name": "Wrist Flexion (-)",
                "positions": [1.57, -0.7, -0.6, 1.57,
                              self.finger_flexion, self.finger_flexion, self.finger_flexion, self.thumb_flexion],
                "checks": [
                    ('palm_assembly:1--palm_axis:1', -0.6),
                ]
            },
            {
                "name": "Wrist Rotation (+)",
                "positions": [0.0, -0.7, -0.6, 1.57,
                              self.finger_flexion, self.finger_flexion, self.finger_flexion, self.thumb_flexion],
                "checks": [
    ...
    def is_value_at_target(self, joint_name: str, target: float, tolerance: float = 0.1) -> bool:
